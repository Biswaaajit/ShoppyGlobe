...
function CheckOut() {
  ...
  return (
    <div className="min-h-screen flex justify-between items-center pt-24 pb-16">
      <div className="w-[90%] sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[40%] flex flex-col border-4 px-2 sm:px-5 py-6 border-slate-300 mx-auto">
        ...
        <button
          onClick={handleOrder}
          className="bg-red-800 hover:bg-red-600 mt-5 text-white w-[70%] lg:w-[60%] py-2 rounded-lg self-center transition-all"
        >
          Place order
        </button>
      </div>
